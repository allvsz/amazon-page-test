    ...
    data.results.map((i,j)=>{
        ...
        if(j == 0) {
            ...
            if(j==1){
                ...
                <div class="card-movie"><img src="https://image.tmdb.org/t/p/w500`+i.backdrop_path+`" /></div>
                `;
            }else{
                main.innerHTML+=`
...
.then(data=>{
    data.results.map((i,j)=>{
        ...
        if(j == 0) {
            ...
            <div class="banner-principal" style=" margin-top:30px; background-image:url('https://image.tmdb.org/t/p/original`+i.backdrop_path+`')"></div>
